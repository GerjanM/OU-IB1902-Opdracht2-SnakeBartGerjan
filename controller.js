...
var snake,
    ...
    movable = true;                  // hulp-boolean die ervoor zorgt dat je maar \'e\'en
    direction = UP;                 // keer een directie kunt opgeven in een interval.
...
width = canvas.width;                    // breedte van het tekenveld
height = canvas.height;                   // hoogte van het tekenveld
xMax = width - 2*R;                     // maximale waarde van x = width - R
ymax = height - 2*R;                     // maximale waarde van y = height - R
createStartSnake();
createFoods();
draw();
